const translations = {
  zh: {
    ...
    cap5Title: "可恢复状态与清理", cap5Copy: "PR 提交后验证远端、保存恢复记录并释放本地 worktree；需要跟进时选择远端编辑或按需恢复本地环境。",
  ...
  en: {
    ...
    cap5Title: "Recoverable state and cleanup", cap5Copy: "After submission, verify remote recovery, save the record, and release local worktrees. Follow up remotely or restore a local environment only when needed.",
