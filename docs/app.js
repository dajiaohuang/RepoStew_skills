const translations = {
  zh: {
    ...
    protocolCopy5: "PR 提交及后续推送验证后立即释放本地工作区；GitHub 与 Email 双轨跟进。",
    ...
    cap4Title: "PR 持续维护", cap4Copy: "GitHub Notifications 与 Email 双轨独立采集到同一 SQLite inbox，按 GitHub 事件版本去重；只报告监控不自动执行。",
    cap5Title: "可恢复状态与清理", cap5Copy: "一次性克隆在 PR 提交后释放；SQLite 保存恢复证据，GitHub 可重建元数据，需要修改时才恢复本地环境。",
  ...
  en: {
    ...
    protocolCopy5: "Release jobs after submission and follow-up validation; maintain through GitHub and Email intake.",
