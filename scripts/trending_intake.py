...
def build_candidate(
    *, batch_id: str, owner_repo: str, ranks: list[dict[str, Any]], metadata: dict[str, Any],
    ...
    return {
        ...
        "completion_signal_policy": "return natural completion or needs-attention to root; immediate event reconciliation; if events unavailable use change-only occupancy snapshots no slower than every 5 seconds",
        "orchestration_poll_interval_seconds": 5,
        ...
        "public_attribution_policy": "strict_no_provider_tool_agent_or_generated_attribution",
